...
class CalculadoraGanhosTest {
    ...
    // Organizando os teste para ter uma única asserção
    ...
    @Test
    public void Dado_um_post_e_autor_Quando_calcular_ganhos_Então_deve_retornar_valor_pago_por_palavra_do_autor() {
        Ganhos ganhos = cacluladora.calcular(post);
